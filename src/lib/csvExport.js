...
export function exportDashboardCSV(scenario, results) {
  ...
  const rows = [
    ...
    { categorie: 'CHARGES',  poste: 'Charges offertes benevoles',         montant_chf: fmt(results.chargesOffertsBenevoles) },
    { categorie: '',         poste: 'Boissons offertes (equipes)',        montant_chf: fmt(results.chargesCotisationsDrinks) },
    { categorie: '',         poste: 'Repas offerts (equipes)',            montant_chf: fmt(results.chargesCotisationsMeals) },
